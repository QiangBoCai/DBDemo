show databases;
 create database  if not exists jpress default character set  utf8 collate utf8_general_ci;
...
CREATE TABLE `mapping` (
  ...
  `category_id` bigint(20) unsigned NOT NULL COMMENT '归类ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='内容和归类的多对多映射关系。';
